    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="flex flex-col justify-center items-center h-96">
          <h1 className="text-6xl font-florent font-bold text-center">I Do Technical SEO.</h1>
          <p className="text-lg text-center mt-3">I help businesses find new growth opportunities through technical SEO, AI, and custom tools.</p>
